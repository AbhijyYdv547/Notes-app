    ...
    return (
        <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
            ...
            <div className="px-4 py-10 md:py-20">
                <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-blue-600 md:text-4xl lg:text-7xl">
                ...
                <p
                    className="relative z-10 mx-auto max-w-xl py-4 text-center text-lg font-normal text-blue-500 "
                >
    ...
    return (
        <nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 px-4 py-4">
            <div className="flex items-center gap-2">
                ...
                <h1 className="text-base font-bold md:text-2xl">Notes App</h1>
            </div>
            <button className="w-24 transform rounded-lg bg-black px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 md:w-32"
                onClick={()=> navigate("/login")}
            >
                Login
            </button>
